...
if (!supabase) {
  $('#onlineWarning').textContent = 'O construtor funciona normalmente. Para usar salas online, configure VITE_SUPABASE_URL e VITE_SUPABASE_PUBLISHABLE_KEY na Vercel.';
